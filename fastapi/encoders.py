...
def jsonable_encoder(
    ...
    """
    from fastapi.observability.config import METRICS_ENCODING
    ...
    is_dataclass_obj = dataclasses.is_dataclass(obj) and not isinstance(obj, type)

    tags = [
        f"obj_type:{obj_type}",
        f"is_pydantic:{is_pydantic}",
        f"is_dataclass:{is_dataclass_obj}"
    ]
